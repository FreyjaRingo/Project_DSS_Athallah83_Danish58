<div class="container">
    ...
    <div class="result-card mt-5">
        <h3 class="mb-4">📊 Hasil Perhitungan WP</h3>
        
        <div class="card">
            <div class="card-header bg-warning text-dark">
                <h5 class="mb-0">Peringkat Alternatif (Vektor V)</h5>
            </div>
            <div class="card-body">
...
function generateInputs() {
    ...
    for (let i = 0; i < numAlts; i++) {
        ...
        for (let j = 0; j < numCrits; j++) {
            html += `<td><input type="number" name="matrix[${i}][${j}]" class="form-control" step="0.01" value="1" required></td>`;
        }
        html += '</tr>';
    }
